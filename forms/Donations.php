...
$query2 = "SELECT TC.intGolferID,TC.strFirstName,TC.strLastName,TTYP.strTypeofTeam 
FROM TGolfers as TC
JOIN ttypeofteams as TTYP 
			 ON TC.intTypeofTeamID = TTYP.intTypeofTeamID
             GROUP BY 
             TC.strFirstName
             ,TC.strLastName,TTYP.strTypeofTeam";
$query3 = "SELECT * FROM `TGenders`";
$query4 = "SELECT * FROM `ttypeofpayment`";
...
<body>
    ...
    <div class="bg">
        ...
        <form action="ProcessDonations.php" name="frmProcess" method="POST">
            ...
            <table class="TableDonate">
                ...
                <tr>
                    ...
                    <td class="letters">
                        <p>Fill out the following information <sup>
                                <font size="1"> *All data is required*</Sub></p>
                    </td>
                </tr>
                <tr>
                    <td class="letters"><label for="txtDates">Todays date</td></label>

                    <td><input type="date" name="txtDates" id="txtDates" required></td>
                </tr>
                <tr>
                ...
                <td class="letters"><label for="txtPaymentType">Select payment type:</td></label>

                <td>

                    <select name="txtPaymentType" id='txtPaymentType' required>
                ...
                <tr>
                    <td class="letters"><label for="txtdonate">enter amount of Donation</td></label>

                    <td><input type="number" name="txtdonate" id="txtdonate" onkeyup=" return validatemoney(this.value);" required></td>
                </tr>
                <tr>
                ...
                <td class="letters"><label for="txtGolferTeams"><b>Select Team you wish to donate: </b></label></td>
                <td><select name="txtGolferTeams" required>

                        <?php while ($row1 = $result2->fetch_assoc()) {

                            echo  "<option value='" . $row1['intGolferID'] . "'>" . $row1['strFirstName'] . ", " . $row1["strLastName"] . " - " . $row1["strTypeofTeam"] . "</option>";
                        }
                        ?>
                        <tr>
                            <td>
